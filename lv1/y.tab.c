...
{
  "$end", "error", "$undefined", "INTEGER", "RETURN", "PRINT", "ID",
  "NUM", "'('", "')'", "'{'", "'}'", "';'", "'='", "$accept", "program",
  "main_function", "stmt_list", "print_stmt", "assignment_stmt",
  "return_stmt", "optional_local_var_decl", "vardecl", YY_NULLPTR
};
#endif
